...
import {
  ...
  AlertOctagon,
  AlertTriangle,
  Briefcase, ChevronDown, ChevronUp, Home, Layers3, LockIcon, LucideIcon, Search, Settings, ShieldAlert, User, Users, X
} from 'lucide-react';
...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl 
    transition-all duration-300 h-full z-40 darl:bg-black overflow-y-auto bg-white
    ...
    <div className={sidebarClassNames}>
      <div className='flex h-[100%] w-full flex-col justify-start dark:bg-black'>
        ...
        <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700 '>
          ...
          <Image src="https://pm-s3-images-iw.s3.us-east-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
        ...
        <button
          ...
          className='flex w-full items-centern justify-between px-8 py-3 text-gray-500'
        >
